 ...
 *  Compilation:  javac MazeGenerator.java.StdDraw.java
 *  Execution:    java MazeGenerator.java.StdDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code MazeGenerator.java.StdDraw} class provides a basic capability for
 *  creating drawings with your programs. It uses a simple graphics model that
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code MazeGenerator.java.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">MazeGenerator.java.StdDraw.java</a>
 ...
 *           MazeGenerator.java.StdDraw.setPenRadius(0.05);
 *           MazeGenerator.java.StdDraw.setPenColor(MazeGenerator.java.StdDraw.BLUE);
 *           MazeGenerator.java.StdDraw.point(0.5, 0.5);
 *           MazeGenerator.java.StdDraw.setPenColor(MazeGenerator.java.StdDraw.MAGENTA);
 *           MazeGenerator.java.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code MazeGenerator.java.StdDraw.line()} and {@code MazeGenerator.java.StdDraw.point()}
 *  draw lines and points; the methods {@code MazeGenerator.java.StdDraw.setPenRadius()}
 *  and {@code MazeGenerator.java.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code MazeGenerator.java.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   MazeGenerator.java.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code MazeGenerator.java.StdDraw.setPenRadius(0.025)} makes
 ...
 *  For example, {@code MazeGenerator.java.StdDraw.setPenColor(MazeGenerator.java.StdDraw.MAGENTA)} sets the
 ...
 *  For example, {@code MazeGenerator.java.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code MazeGenerator.java.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   MazeGenerator.java.StdDraw.setFont(font);
 *   MazeGenerator.java.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *  {@code MazeGenerator.java.StdDraw.clear(MazeGenerator.java.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray.
 *  <p>
 ...
 *  <pre>
 *   MazeGenerator.java.StdDraw.setScale(-2, +2);
 *   MazeGenerator.java.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       MazeGenerator.java.StdDraw.clear();
 *       MazeGenerator.java.StdDraw.filledCircle(x, y, 0.05);
 *       MazeGenerator.java.StdDraw.filledCircle(-x, -y, 0.05);
 *       MazeGenerator.java.StdDraw.show();
 *       MazeGenerator.java.StdDraw.pause(20);
 *   }
 *  </pre>
 *  <p>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    ***************************************************************************/
     ...
     * {@code MazeGenerator.java.StdDraw.BLACK}, {@code MazeGenerator.java.StdDraw.BLUE}, {@code MazeGenerator.java.StdDraw.CYAN},
     * {@code MazeGenerator.java.StdDraw.DARK_GRAY}, {@code MazeGenerator.java.StdDraw.GRAY}, {@code MazeGenerator.java.StdDraw.GREEN},
     * {@code MazeGenerator.java.StdDraw.LIGHT_GRAY}, {@code MazeGenerator.java.StdDraw.MAGENTA}, {@code MazeGenerator.java.StdDraw.ORANGE},
     * {@code MazeGenerator.java.StdDraw.PINK}, {@code MazeGenerator.java.StdDraw.RED}, {@code MazeGenerator.java.StdDraw.WHITE}, and
     * {@code MazeGenerator.java.StdDraw.YELLOW}.
     *
    ...
    ***************************************************************************/
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to MazeGenerator.java.StdDraw)
        if ((icon == null) || (icon.getImageLoadStatus() != MediaTracker.COMPLETE)) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to MazeGenerator.java.StdDraw)
        try {
            URL url = MazeGenerator.java.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        } 
        catch (IOException e) {
